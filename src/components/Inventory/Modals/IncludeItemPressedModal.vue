...
onMounted(() => {
    ...
    equipmentCopiesArray.value = filteredCopiesOfItem.value.map((e_copy) => ({
        ...e_copy,
        is_selected: props.currentlySelectedItems.some(item => item.item_copy_id === e_copy.id && item.item_type === "Equipment Copy"),
    }));
    // console.log("🚀 ~ equipmentCopiesArray.value=filteredCopiesOfItem.value.map ~ equipmentCopiesArray:", equipmentCopiesArray)
    ...
    <div v-if="modelValue"
        ...
        <div v-else ref="modalContainer"
            ...
            <h3 class="text-3xl font-semibold mb-4">
                {{ props.selectedItem.supply_name || props.selectedItem.equipment_name }}
            </h3>
            ...
            <div v-if="props.selectedItem.type === 'Office Equipment' && equipmentCopiesArray.length > 0"
                ...
                <label class="block mt-4 mb-2 text font-medium text-gray-900 dark:text-gray-200">Select Copy/ies:</label>
